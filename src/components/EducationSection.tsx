      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <SectionReveal delay={0.1}>
            <div className="glass-card rounded-2xl p-7 h-full transition-all duration-500">
              ...
              <div className="space-y-6 relative">
                ...
                {education.map((e) => (
                  <div key={e.title} className="flex gap-5 relative">
                    <div className="w-3.5 h-3.5 rounded-full bg-primary/20 border-2 border-primary shrink-0 mt-1 z-10" />
                    <div>
