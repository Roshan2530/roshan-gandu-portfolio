      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <SectionReveal delay={0.1}>
            <div className="space-y-5">
              ...
              {contactInfo.map(({ icon: Icon, label, href }) => (
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-primary/10 border border-primary/20 flex items-center justify-center group-hover:shadow-[0_0_15px_hsl(var(--primary)/0.3)] transition-all duration-300">
          ...
          <SectionReveal delay={0.2}>
            <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-7 space-y-5 transition-all duration-500">
              <div>
                <Input
